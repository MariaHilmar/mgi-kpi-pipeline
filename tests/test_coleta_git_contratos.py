...
def test_validar_repo_usa_wsl():
    coleta = cgc.GitColeta(r"\\wsl.localhost\Ubuntu\root\MGI\contratos_v2", "contratos_v2")
...
def test_run_git_remove_prefixo_git():
    coleta = cgc.GitColeta(r"\\wsl.localhost\Ubuntu\root\MGI\contratos", "contratos")
